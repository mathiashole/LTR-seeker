...
ggdensitree(gy_df_tree, alpha=.3, colour='steelblue') + 
...
cut_branchs <- ggtree(k_datab, aes(color=group)) +
...
##extract clades________________________________________________________________

clade_374 <- extract.clade(clade_athila, 374)
clade_308 <- extract.clade(clade_athila, 308)
clade_471 <- extract.clade(clade_athila, 471)
clade_478 <- extract.clade(clade_athila, 478)
clade_499 <- extract.clade(clade_athila, 499)
clade_558 <- extract.clade(clade_athila, 558)
clade_596 <- extract.clade(clade_athila, 596)

ggtree(clade_465) + geom_text(aes(label=node), hjust=-0.2) + 
  geom_tiplab(size=3, color="purple")
